...
public final class DashboardWebInterface extends WebInterface implements DashboardCallback {
    ...
    @JavascriptInterface
    @Override
    public void onReferenceClick(final String href) {
        handleCallback(new Runnable() {
            @Override
            public void run() {
                delegate.onReferenceClick(href);
            }
        });
    }
    ...
    public void onRemotePageClick(final String href, final String page) {
        handleCallback(new Runnable() {
            @Override
            public void run() {
                delegate.onRemotePageClick(href, page);
            }
        });
    }
    ...
    public void onRemoteAnchorClick(final String href, final String anchor) {
        handleCallback(new Runnable() {
            @Override
            public void run() {
                delegate.onRemoteAnchorClick(href, anchor);
            }
        });
    }
